...
#
#    ConvertOpenfoam2SU2  is distributed in the hope that it will be useful,
...
# =========================
nameFile = input("Enter the name of the input file:")
listLinesInput = []
try:
...
try:
	print("Reading the 'neighbour' file")
...
listBoundaries = {}
try:
	print("Reading the 'boundary' file")
